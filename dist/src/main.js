...
editviewapp.apipath = 'http://localhost:3000/Api/'
...
editviewapp.service('route', ['$state', function($state) {
...
angular.module('KaakateeyaEdit').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('editview/app/views/editPartnerPreferences.html',
    ...
    "                                <h6>\r" +
    "\n" +
    "                                    <span id=\"preferredstar\" style=\"font-weight:bold;\">{{(item.TypeOfStar==='1'?'Non preferred stars':'Preferred stars')}}</span></h6>\r" +
    "\n" +
    "                                <h5>\r" +
    "\n" +
  ...
  $templateCache.put('editview/app/views/oldAlert.html',
    ...
    "    .editAlertcls {\r" +
    "\n" +
    "        z-index: 9999999999 !important;\r" +
    "\n" +
    "    }\r" +
    "\n" +
    "</style>"
