...
angular.module('KaakateeyaEdit').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('editview/app/views/educationAndProfession.html',
    ...
    "\r" +
    "\n" +
    "                                <input ng-model=\"profObj.txtsalary\" class=\"form-control\" onchange=\"currency();\" maxlength=\"7\" tabindex=\"6\" />\r" +
    "\n" +
    "\r" +
    "\n" +
    "                            </div>\r" +
  ...
  $templateCache.put('editview/masterView/footer.html',
    ...
    "\n" +
    "            <p><span>Kaakateeya.com</span>, a top-notch online matrimonial site committed to deliver high quality match making\r" +
    "\n" +
    "                service since 1982.</p>\r" +
    "\n" +
    "        </div>\r" +
    "\n" +
    "        <div class=\"span2\">\r" +
